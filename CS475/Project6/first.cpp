...
// include arrayMult and arrayMultAdd cl function
...
int main(int argc, char *argv[])
{
	...
	for (int i = 0; i < NUM_ELEMENTS; i++)
	{
		...
		// TODO check how results look and potentially change it to an arbitrary val
		hC[i] = 1.;
	}
	...
	// TODO we can make an ifndef with flags if we want
	...
	// move from device array D to host array D
